...
## Base Unit
Use 4px as your base unit (not 8px — 8px is too coarse; values like 12px fall between steps). Scale:
- 2xs: 2px
- xs: 4px
- sm: 8px
- md: 16px
...
- Use the scale consistently — but vary the values intentionally to create rhythm; uniform spacing everywhere feels monotonous
