...
- **Baseline grid**: Vertical rhythm alignment (4px base)
...
- Card grids: auto-fill responsive cards — vary sizing, density, or content structure to avoid templated repetition
## Best Practices
